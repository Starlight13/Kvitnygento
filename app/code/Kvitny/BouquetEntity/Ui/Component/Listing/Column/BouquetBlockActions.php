...
namespace Kvitny\BouquetEntity\Ui\Component\Listing\Column;
 ...
 */
class BouquetBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'Bouquet';

    /**
     * Url paths.
     * #@+
     */
    private const EDIT_URL_PATH = 'bouquet/bouquet/edit';
    private const DELETE_URL_PATH = 'bouquet/bouquet/delete';
    /** #@- */
    ...
    public function prepareDataSource(array $dataSource): array
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item['bouquet_id'])) {
                    $entityName = static::ENTITY_NAME;
                    $urlData = ['bouquet_id' => $item['bouquet_id']];
